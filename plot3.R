...
# 2. CREATING GRAPH 3 IN FILE PNG DEVICE
...
# setting the plot
plot(twodaysdata$Time, twodaysdata$Sub_metering_1,
     type="n",
     ylab = "Energy submetering",
     xlab = "")

# actual line plot of the three submetering variables in different colors
lines(twodaysdata$Time, twodaysdata$Sub_metering_1, col = "black")
lines(twodaysdata$Time, twodaysdata$Sub_metering_2, col = "red")
lines(twodaysdata$Time, twodaysdata$Sub_metering_3, col = "blue")
